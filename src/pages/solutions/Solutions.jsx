...
const localizedDetails = {
  ...
  kn: {
    backBtn: "ಬೆಳೆ ಪರಿಹಾರಗಳ ಮುಖಪುಟಕ್ಕೆ ಹಿಂತಿರುಗಿ",
    shelfTitle: "🌱 {title} ಗಾಗಿ ಶಿಫಾರಸು ಮಾಡಿದ ಜೈವಿಕ ಪರಿಹಾರಗಳು",
    soil_health: {
      problemTitle: "ಸವಾಲುಗಳು: ಮಣ್ಣಿನ ಆರೋಗ್ಯದ ಅವನತಿ ಮತ್ತು ಫಲವತ್ತತೆಯ ನಷ್ಟ",
      problemDesc: "ರಾಸಾಯನಿಕ ಗೊಬ್ಬರಗಳ ಅತಿಯಾದ ಬಳಕೆಯಿಂದಾಗಿ ಮಣ್ಣಿನ ಸಾವಯವ ಇಂಗಾಲ ಕಡಿಮೆಯಾಗುತ್ತದೆ, ಉಪಯುಕ್ತ ಸೂಕ್ಷ್ಮಜೀವಿಗಳ ಸಂಖ್ಯೆ ಕ್ಷೀಣಿಸುತ್ತದೆ, ಮಣ್ಣು ಗಟ್ಟಿಯಾಗುತ್ತದೆ ಮತ್ತು pH ಸಮತೋಲನ ತಪ್ಪುತ್ತದೆ. ಇದರಿಂದ ಮಣ್ಣಿನ ನೀರು ಹಿಡಿದಿಟ್ಟುಕೊಳ್ಳುವ ಸಾಮರ್ಥ್ಯ ಕಡಿಮೆಯಾಗಿ ಗೊಬ್ಬರಗಳ ದಕ್ಷತೆ ಕುಂಠಿತಗೊಳ್ಳುತ್ತದೆ.",
      problemPoints: ["ನೈಸರ್ಗಿಕ ಸಾವಯವ ಇಂಗಾಲದ (SOC) ಕೊರತೆ", "ಮಣ್ಣು ಗಟ್ಟಿಯಾಗುವುದು ಮತ್ತು ಬೇರುಗಳಿಗೆ ಗಾಳಿಯಾಡದಿರುವುದು", "ಸೂಕ್ಷ್ಮಜೀವಿಗಳ ಅಸಮತೋಲನ ಮತ್ತು ರೋಗಕಾರಕಗಳ ಹೆಚ್ಚಳ"],
      solutionTitle: "ಜೈವಿಕ ಪರಿಹಾರ: ಮಣ್ಣಿನ ಫಲವತ್ತತೆಯ ಮರುಸ್ಥಾಪನೆ",
      solutionDesc: "ನಮ್ಮ ಸುಧಾರಿತ ಜೈವಿಕ ಉತ್ಪನ್ನಗಳು ಮಣ್ಣಿಗೆ ಸಾರಜನಕ ಸ್ಥಿರೀಕರಿಸುವ, ರಂಜಕ ಕರಗಿಸುವ ಮತ್ತು ಪೊಟ್ಯಾಶ್ ಸಜ್ಜುಗೊಳಿಸುವ ಬ್ಯಾಕ್ಟೀರಿಯಾಗಳನ್ನು ಒದಗಿಸುತ್ತವೆ. ಇದು ಮಣ್ಣಿನ ಸಾವಯವ ಇಂಗಾಲವನ್ನು ಹೆಚ್ಚಿಸಿ ರಚನೆಯನ್ನು ಸುಧಾರಿಸುತ್ತದೆ.",
      solutionPoints: ["ಉಪಯುಕ್ತ ಬ್ಯಾಕ್ಟೀರಿಯಾಗಳ ಸಂಖ್ಯೆಯನ್ನು ಮರುಸ್ಥಾಪಿಸುವುದು", "ಸಾವಯವ ಇಂಗಾಲ ಮತ್ತು ಮಣ್ಣಿನ ರಚನೆಯನ್ನು ಸುಧಾರಿಸುವುದು", "pH ಸಮತೋಲನಗೊಳಿಸಿ ಪೋಷಕಾಂಶಗಳ ಲಭ್ಯತೆಯನ್ನು ಹೆಚ್ಚಿಸುವುದು"]
    },
    nutrient_management: {
      problemTitle: "ಸವಾಲುಗಳು: ಪೋಷಕಾಂಶಗಳ ಕೊರತೆ ಮತ್ತು ಗೊಬ್ಬರಗಳು ಮಣ್ಣಿನಲ್ಲಿ ಕರಗದಿರುವುದು",
      problemDesc: "ಬೆಳೆಗಳ ಉತ್ತಮ ಬೆಳವಣಿಗೆಗೆ ಸಾರಜನಕ, ರಂಜಕ, ಪೊಟ್ಯಾಶ್ ಜೊತೆಗೆ ಸತು, ಕಬ್ಬಿಣ, ಬೋರಾನ್ ಮುಂತಾದ ಸೂಕ್ಷ್ಮ ಪೋಷಕಾಂಶಗಳ ಅಗತ್ಯವಿದೆ. ರಾಸಾಯನಿಕ ಗೊಬ್ಬರಗಳು ಮಣ್ಣಿನಲ್ಲಿ ಕರಗದ ರೂಪದಲ್ಲಿ ಉಳಿದು ಸಸ್ಯಗಳಿಗೆ ಲಭ್ಯವಾಗುವುದಿಲ್ಲ.",
      problemPoints: ["ಮಣ್ಣಿನಲ್ಲಿ ಕರಗದ ರೂಪದಲ್ಲಿ ಉಳಿಯುವ ರಂಜಕ ಮತ್ತು ಪೊಟ್ಯಾಶ್", "ಸೂಕ್ಷ್ಮ ಪೋಷಕಾಂಶಗಳ ಕೊರತೆ (ಸತು, ಕಬ್ಬಿಣ, ಬೋರಾನ್)", "ಕುಂಠಿತಗೊಂಡ ಬೆಳವಣಿಗೆ ಮತ್ತು ಗೊಬ್ಬರಗಳ ನಿಷ್ಪ್ರಯೋಜಕತೆ"],
      solutionTitle: "ಜೈವಿಕ ಪರಿಹಾರ: ಸಮತೋಲಿತ ಮತ್ತು ಸುಲಭವಾಗಿ ಲಭ್ಯವಾಗುವ ಪೋಷಣೆ",
      solutionDesc: "ನಾವು ಜೈವಿಕ ಚಿಲೇಟ್ಸ್, ಸೂಕ್ಷ್ಮಜೀವಿಗಳ ಒಕ್ಕೂಟ ಮತ್ತು ಸಾವಯವ ಪೋಷಕಾಂಶಗಳನ್ನು ಒದಗಿಸುತ್ತೇವೆ. ಇವು ಮಣ್ಣಿನಲ್ಲಿ ಕರಗದೆ ಇರುವ ಪೋಷಕಾಂಶಗಳನ್ನು ಕರಗಿಸಿ ಬೇರುಗಳ ಮೂಲಕ ಸಸ್ಯಗಳಿಗೆ ತಲುಪಿಸುತ್ತವೆ.",
      solutionPoints: ["ಸಾರಜನಕ ಸ್ಥಿರೀಕರಣ ಮತ್ತು ರಂಜಕ ಕರಗಿಸುವಿಕೆಯನ್ನು ಹೆಚ್ಚಿಸುವುದು", "ವೇಗವಾಗಿ ಹೀರಿಕೊಳ್ಳಲು ಸಮತೋಲಿತ ಚಿಲೇಟೆಡ್ ಸೂಕ್ಷ್ಮ ಪೋಷಕಾಂಶಗಳ ಪೂರೈಕೆ", "ಗೊಬ್ಬರಗಳ ದಕ್ಷತೆಯನ್ನು ಹೆಚ್ಚಿಸಿ ಬೆಳೆಗಳ ಏಕರೂಪದ ಬೆಳವಣಿಗೆಯನ್ನು ಖಚಿತಪಡಿಸುವುದು"]
    },
    pest_disease: {
      problemTitle: "ಸವಾಲುಗಳು: ಕೀಟಗಳ ಹಾವಳಿ ಮತ್ತು ರಾಸಾಯನಿಕ ಉಳಿಕೆಗಳು",
      problemDesc: "ಕೀಟಗಳು ಮತ್ತು ಬೂಷ್ಟು ರೋಗಗಳು ಬೆಳೆಗಳಿಗೆ ಹಾಗೂ ಇಳುವರಿಗೆ ಭಾರಿ ಹಾನಿ ಉಂಟುಮಾಡುತ್ತವೆ. ರಾಸಾಯನಿಕ ಕೀಟನಾಶಕಗಳು ಕೀಟಗಳಲ್ಲಿ ನಿರೋಧಕ ಶಕ್ತಿಯನ್ನು ಹೆಚ್ಚಿಸುತ್ತವೆ ಮತ್ತು ಬೆಳೆಗಳ ಮೇಲೆ ವಿಷಕಾರಿ ರಾಸಾಯನಿಕ ಉಳಿಕೆಗಳನ್ನು ಬಿಡುತ್ತವೆ.",
      problemPoints: ["ಕೀಟಗಳಲ್ಲಿ ನಿರೋಧಕ ಶಕ್ತಿ ಹೆಚ್ಚಳ ಮತ್ತು ಕೀಟನಾಶಕಗಳ ವೈಫಲ್ಯ", "ಕೊಯ್ಲು ಮಾಡಿದ ಉತ್ಪನ್ನಗಳ ಮೇಲೆ ವಿಷಕಾರಿ ರಾಸಾಯನಿಕ ಉಳಿಕೆಗಳು", "ಪರಿಸರ ಮಾಲಿನ್ಯ ಮತ್ತು ಮಿತ್ರ ಕೀಟಗಳಿಗೆ ಹಾನಿ"],
      solutionTitle: "ಜೈವಿಕ ಪರಿಹಾರ: ನೈಸರ್ಗಿಕ ಮತ್ತು ಸುರಕ್ಷಿತ ಬೆಳೆ ರಕ್ಷಣೆ",
      solutionDesc: "ನಮ್ಮ ಜೈವಿಕ ನಿಯಂತ್ರಣ ಪರಿಹಾರಗಳು ಉಪಯುಕ್ತ ಶಿಲೀಂಧ್ರಗಳು (ಮೆಟಾರೈಜಿಯಂ, ಟ್ರೈಕೋಡರ್ಮಾ) ಮತ್ತು ಬೇವಿನ ಸಾರವನ್ನು ಬಳಸುತ್ತವೆ. ಇವು ಬೆಳೆಗಳ ಮೇಲೆ ಯಾವುದೇ ವಿಷಕಾರಿ ಉಳಿಕೆಗಳನ್ನು ಬಿಡದೆ ಕೀಟಗಳನ್ನು ಪರಿಣಾಮಕಾರಿಯಾಗಿ ನಿಯಂತ್ರಿಸುತ್ತವೆ.",
      solutionPoints: ["ಕೀಟ ಮತ್ತು ರೋಗಗಳ ವಿರುದ್ಧ ಸಮಗ್ರ ಜೈವಿಕ ನಿಯಂತ್ರಣ", "ಯಾವುದೇ ರಾಸಾಯನಿಕ ಉಳಿಕೆಗಳಿಲ್ಲ, ಬೆಳೆ ಮತ್ತು ಪರಿಸರಕ್ಕೆ ಸಂಪೂರ್ಣ ಸುರಕ್ಷಿತ", "ಸಮಗ್ರ ಕೀಟ ನಿರ್ವಹಣೆಗೆ (IPM) ಸೂಕ್ತ, ಮಿತ್ರ ಕೀಟಗಳ ರಕ್ಷಣೆ"]
    },
    growth_enhancement: {
      problemTitle: "ಸವಾಲುಗಳು: ಹವಾಮಾನ ವೈಪರೀತ್ಯ ಮತ್ತು ಇಳುವರಿ ಇಳಿಕೆ",
      problemDesc: "ಸಮರ್ಪಕ ಗೊಬ್ಬರಗಳನ್ನು ನೀಡಿದರೂ ಸಹ, ಬರಗಾಲ, ಅತಿಯಾದ ತಾಪಮಾನ ಮತ್ತು ಉಪ್ಪಿನಂಶವಿರುವ ಮಣ್ಣಿನಂತಹ ಪ್ರತಿಕೂಲ ಹವಾಮಾನದಿಂದಾಗಿ ಹೂವು ಹಾಗೂ ಕಾಯಿಗಳು ಉದುರುತ್ತವೆ, ಗುಣಮಟ್ಟ ಕುಂಠಿತಗೊಂಡು ಗರಿಷ್ಠ ಇಳುವರಿ ಸಿಗುವುದಿಲ್ಲ.",
      problemPoints: ["ಒತ್ತಡದ ಪರಿಸ್ಥಿತಿಯಿಂದಾಗಿ ಹೂವು ಮತ್ತು ಕಾಯಿಗಳು ಉದುರುವುದು", "ಹಣ್ಣುಗಳ ಕಳಪೆ ಗುಣಮಟ್ಟ, ಗಾತ್ರ ಮತ್ತು ತೂಕದಲ್ಲಿ ಇಳಿಕೆ", "ಬೆಳೆಯ ಪೂರ್ಣ ಉತ್ಪಾದಕತೆಯ ಸಾಮರ್ಥ್ಯವನ್ನು ತಲುಪದಿರುವುದು"],
      solutionTitle: "ಜೈವಿಕ ಪರಿಹಾರ: ಚಯಾಪಚಯ ಕ್ರಿಯೆಯ ಸುಧಾರಣೆ ಮತ್ತು ಇಳುವರಿ ಹೆಚ್ಚಳ",
      solutionDesc: "ನಮ್ಮ ಬಯೋಸ್ಟಿಮ್ಯುಲಂಟ್ಸ್, ಅಮೈನೋ ಆಮ್ಲಗಳು ಮತ್ತು ಸಸ್ಯ ಬೆಳವಣಿಗೆ ನಿಯಂತ್ರಕಗಳು ಬೆಳೆಯ ಚಯಾಪಚಯ ಕ್ರಿಯೆಯನ್ನು ಉತ್ತಮಗೊಳಿಸುತ್ತವೆ, ಬೇರುಗಳ ಬೆಳವಣಿಗೆಯನ್ನು ಪ್ರಚೋದಿಸುತ್ತವೆ ಮತ್ತು ಹೂವು ಉದುರುವುದನ್ನು ತಡೆಯುತ್ತವೆ.",
      solutionPoints: ["ಹೂವು ಮತ್ತು ಕಾಯಿ ಉದುರುವುದನ್ನು ತಡೆದು ಗುಣಮಟ್ಟವನ್ನು ಹೆಚ್ಚಿಸುವುದು", "ಬರಗಾಲ ಮತ್ತು ತಾಪಮಾನದಂತಹ ಒತ್ತಡದ ಪರಿಸ್ಥಿತಿಗಳನ್ನು ತಡೆದುಕೊಳ್ಳುವ ಶಕ್ತಿ ಹೆಚ್ಚಳ", "ಹೆಚ್ಚಿನ ಇಳುವರಿಗಾಗಿ ಸಸ್ಯದ ಚಯಾಪಚಯ ಕ್ರಿಯೆಯನ್ನು ಉತ್ತೇಜಿಸುವುದು"]
    }
  },
  mr: {
...
export default function Solutions() {
  ...
  if (slug && solutionCategoryMapping[slug]) {
    ...
    const lang = i18n.language?.startsWith('zh') ? 'zh' : i18n.language?.startsWith('hi') ? 'hi' : i18n.language?.startsWith('gu') ? 'gu' : i18n.language?.startsWith('mr') ? 'mr' : i18n.language?.startsWith('kn') ? 'kn' : 'en';
