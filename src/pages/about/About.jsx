...
export default function About() {
  ...
  return (
    <GenericPage title="About Jay Agritech" subtitle="Pioneering sustainable agriculture with science-backed biological solutions from the heart of Gujarat." breadcrumbs={[{ label: 'About' }]}>
      <div className="container">
          ...
          <section className="section">
            <div className="grid-2" style={{ gap: 'var(--sp-10)', alignItems: 'start' }}>
              <div className="card" style={{ padding: 'var(--sp-8)', borderLeft: '4px solid var(--clr-primary)' }}>
                <h3 style={{ marginBottom: 'var(--sp-3)', color: 'var(--clr-primary)' }}>Our Vision</h3>
                <p style={{ fontSize: 'var(--fs-body-lg)', lineHeight: 'var(--lh-loose)' }}>{companyInfo.vision}</p>
              </div>
              <div className="card" style={{ padding: 'var(--sp-8)', borderLeft: '4px solid var(--clr-accent-gold)' }}>
                <h3 style={{ marginBottom: 'var(--sp-3)', color: 'var(--clr-accent-gold-dark)' }}>Our Mission</h3>
                <p style={{ fontSize: 'var(--fs-body-lg)', lineHeight: 'var(--lh-loose)' }}>{companyInfo.mission}</p>
              </div>
            </div>
          </section>
        </AnimatedSection>
        ...
        <AnimatedSection>
          <section className="section">
            <div className="section-header"><span className="section-overline">Core Values</span><h2 className="section-title">What Drives Us</h2></div>
              ...
              {companyInfo.values.map((val, i) => {
                ...
                return (
                  <div key={i} className="card hover-lift" style={{ padding: 'var(--sp-6)', textAlign: 'center' }}>
                    ...
                    <h4 style={{ marginBottom: 'var(--sp-2)' }}>{val.title}</h4>
                    <p style={{ fontSize: 'var(--fs-body-sm)', color: 'var(--clr-text-muted)' }}>{val.description}</p>
                  </div>
                );
              })}
            </div>
        ...
        <AnimatedSection>
          <section className="section">
            <div className="section-header"><span className="section-overline">Leadership</span><h2 className="section-title">Meet Our Team</h2></div>
        ...
        <AnimatedSection>
          <section className="section">
            <div className="section-header"><span className="section-overline">Our Journey</span><h2 className="section-title">Key Milestones</h2></div>
        ...
        <AnimatedSection>
          <section className="section" style={{ background: 'var(--clr-off-white)', borderRadius: 'var(--radius-xl)', padding: 'var(--sp-12)' }}>
            <div className="section-header"><span className="section-overline">Quality & Compliance</span><h2 className="section-title">Our Certifications</h2></div>
            <div className="grid-3">
