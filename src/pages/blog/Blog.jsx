...
export default function Blog() {
  ...
  const locale = i18n.language?.startsWith('hi') ? 'hi-IN' : i18n.language?.startsWith('gu') ? 'gu-IN' : i18n.language?.startsWith('mr') ? 'mr-IN' : i18n.language?.startsWith('kn') ? 'kn-IN' : 'en-IN';
