...
export default function ChatBot() {
  ...
  const activeLang = i18n.language?.startsWith('zh') ? 'zh' : i18n.language?.startsWith('hi') ? 'hi' : i18n.language?.startsWith('gu') ? 'gu' : i18n.language?.startsWith('mr') ? 'mr' : i18n.language?.startsWith('kn') ? 'kn' : 'en';
    ...
    gu: [
      {
        ...
        answer: "### જય એગ્રીટેક પ્રાઇવેટ લિમિટેડ\nઅમે વલસાડ, ગુજરાતમાં સ્થિત એક અગ્રણી **એગ્રી-બાયોટેક કંપની** છીએ, જેની સ્થાપના **૨૦૨૫** માં કરવામાં આવી છે.\n\nઅમારું મુખ્ય મિશન **ટકાઉ વિકાસ** ને પ્રોત્સાહન આપવાનું છે:\n- જમીનની જૈવિક ગુણવત્તા સુધારવા માટે **ઉચ્ચ કાર્યક્ષમતા ધરાવતા જૈવિક ખાતરો**\n- સેન્દ્રિય કાર્બન વધારવા માટે **OMRI-પ્રમાણિત ઓર્ગેનિક ખાતરો**\n- રસાયણ-મુક્ત જીવાત નિયંત્રણ માટે **પર્યાવરણ-સુરક્ષિત જૈવિક જંતુનાશકો**"
      },
      {
        question: "તમે કયા ઉત્પાદનો ઓફર કરો છો?",
        answer: "### અમારું પ્રોડક્ટ પોર્ટફોલિયો\nઅમે ૫ શ્રેણીઓમાં **૬૦+ પ્રીમિયમ કૃષિ ઉકેલો** નું ઉત્પાદન કરીએ છીએ:\n- **જૈવિક ખાતરો:** NB, PB, KB, ZB અને માઇકોરૂટ (VAM)\n- **બાયોસ્ટિમ્યુલેન્ટ્સ:** રાઇઝોસ્ફીયર સક્રિયકર્તાઓ (ધરા મેક્સ, ફ્લોરલ)\n- **ઓર્ગેનિક પોષક તત્વો:** OMRI-પ્રમાણિત ભૂમિરિચ અને ક્રોપચાર્જ સેન્દ્રિય ખાતર\n- **જૈવિક જંતુનાશકો:** જૈવિક જીવાત નિયંત્રણ (ઓર્ગો મેટા, ઓર્ગો નીમ)\n- **સૂક્ષ્મ પોષકતત્વો:** આવશ્યક સંતુલિત ખનિજ ઉકેલો (માઇક્રોઝેસ્ટ)"
      },
      {
        question: "હું ડીલર કે ડિસ્ટ્રિબ્યુટર કેવી રીતે બની શકું?",
        answer: "### અમારા પાર્ટનર નેટવર્કમાં જોડાઓ\nઅમે સમગ્ર **ભારત** માં અમારા રિટેલ અને વિતરણ નેટવર્કનો સક્રિયપણે વિસ્તાર કરી રહ્યા છીએ!\n\n**કેવી રીતે અરજી કરવી:**\n- **પગલું ૧:** અમારા મેનૂમાં **'Become a Partner'** (ભાગીદાર બનો) વિભાગ પર જાઓ.\n- **પગલું ૨:** ડીલર અથવા ડિસ્ટ્રિબ્યુટરનું ઝડપી અરજી ફોર્મ ભરો.\n- **પગલું ૩:** અમારી સેલ્સ ડેવલપમેન્ટ ટીમ **૨૪ કલાક** ની અંદર તમારો સંપર્ક કરશે!\n\nતમે શરૂ કરવા માટે સીધા **sales@jayagritech.com** પર પણ અમને ઇમેઇલ કરી શકો છો."
      },
      {
        question: "શું તમે પ્રાઇવેટ લેબલિંગ કે કોન્ટ્રાક્ટ મેન્યુફેક્ચરિંગ ઓફર કરો છો?",
        answer: "### કસ્ટમ B2B સોલ્યુશન્સ\nહા! અમે **કોન્ટ્રાક્ટ મેન્યુફેક્ચરિંગ** અને **OEM પ્રાઇવેટ લેબલિંગ** માટે વિશ્વસનીય ભાગીદાર છીએ.\n\n**અમારી B2B ક્ષમતાઓ:**\n- અત્યાધુનિક માઇક્રોબાયોલોજી અને ફોર્મ્યુલેશન **R&D લેબ**\n- કસ્ટમ પ્રવાહી, પાવડર અને દાણાદાર મિશ્રણ ક્ષમતા\n- સંપૂર્ણ પ્રમાણિત **ISO 9001:2015 અને FCO** સુસંગત પ્રક્રિયાઓ\n- ઝડપી માર્કેટ લોન્ચ માટે વ્હાઇટ લેબલ વિકલ્પો"
      },
      {
        question: "તમારી કંપની ક્યાં આવેલી છે?",
        answer: "### અમારું સ્થાન\nઅમારું કોર્પોરેટ હેડક્વાર્ટર અને ઉત્પાદન સુવિધાઓ **વલસાડ, ગુજરાત, ભારતમાં** આવેલી છે.\n\n- **વલસાડ** એ પશ્ચિમ ભારતમાં ઉત્તમ લોજિસ્ટિક્સ કનેક્ટિવિટી ધરાવતો એક પ્રીમિયમ ઔદ્યોગિક કોરિડોર છે.\n- તમે અમારા **Contact** (સંપર્ક) પેજ પર અમારું **ચોક્કસ સ્થાન અને રૂટ મેપ** જોઈ શકો છો."
      },
      {
        question: "તમારા ઉત્પાદનો પાસે કયા પ્રમાણપત્રો છે?",
        answer: "### પ્રમાણિત ઓર્ગેનિક અને ગુણવત્તા ચકાસાયેલ\nઅમારા ઉત્પાદનો કડક ગુણવત્તા નિયંત્રણ હેઠળ બને છે અને તેમની પાસે બહુવિધ રાષ્ટ્રીય અને આંતરરાષ્ટ્રીય પ્રમાણપત્રો છે:\n- પ્રમાણિત ઓર્ગેનિક ઉત્પાદનમાં ઉપયોગ માટે **OMRI લિસ્ટેડ**.\n- **ISO 9001:2015** પ્રમાણિત ઉત્પાદન અને R&D સુવિધાઓ.\n- **FCO (ખાતર નિયંત્રણ ઓર્ડર)** સુસંગત ફોર્મ્યુલેશન્સ.\n- **NPOP (ઓર્ગેનિક ઉત્પાદન માટેનો રાષ્ટ્રીય કાર્યક્રમ)** પ્રમાણિત ખાતરો."
      },
      {
        question: "જૈવિક ખાતરો જમીનના જૈવિક સ્વાસ્થ્યને કેવી રીતે સુધારે છે?",
        answer: "### જમીન પુનઃજીવન\nજૈવિક ખાતરોમાં જૈવિક સૂક્ષ્મજીવો હોય છે જે જમીનના સ્વાસ્થ્યને કુદરતી રીતે પુનઃસ્થાપિત કરે છે:\n- **નાઇટ્રોજન સ્થિરીકરણ:** વાતાવરણના નાઇટ્રોજનને ગ્રહણ કરી છોડને ઉપલબ્ધ બનાવે છે.\n- **પોષક તત્વો ઓગળવા:** જમીનમાં જમા થયેલા અદ્રાવ્ય ફોસ્ફરસ, પોટેશિયમ અને ઝીંકને છોડ શોષી શકે તેવા સ્વરૂપમાં ફેરવે છે.\n- **માઇક્રોબાયોમ સમૃદ્ધિ:** જમીનમાં કાર્બનનું સ્તર અને ફાયદાકારક સૂક્ષ્મજીવોની પ્રવૃત્તિ વધારે છે."
      },
      {
        question: "શું આપણે ટ્રાયલ માટે ઉત્પાદનના સેમ્પલ મંગાવી શકીએ?",
        answer: "### સેમ્પલ વિનંતી કરો\nહા! અમે ફીલ્ડ ટ્રાયલ્સ અને વ્યવસાયિક પરીક્ષણોને ટેકો આપીએ છીએ:\n- **કોણ વિનંતી કરી શકે:** નોંધાયેલા ડીલરો, વ્યાપારી ખેડૂતો અને સંસ્થાઓ.\n- **ટ્રાયલ સપોર્ટ:** અમારી એગ્રોનોમી ટીમ તમને ડોઝ અને દેખરેખ અંગે માર્ગદર્શન આપશે.\n- **કેવી રીતે વિનંતી કરવી:** તમારા સ્થાનિક સેલ્સ મેનેજરનો સંપર્ક કરો અથવા અમારા **Contact Us** ફોર્મ દ્વારા વિનંતી મોકલો."
      }
    ],
    kn: [
      {
        question: "ಜಯ್ ಅಗ್ರಿಟೆಕ್ ಎಂದರೇನು?",
        answer: "### ಜಯ್ ಅಗ್ರಿಟೆಕ್ ಪ್ರೈವೇಟ್ ಲಿಮಿಟೆಡ್\nನಾವು ಗುಜರಾತ್‌ನ ವಲ್ಸಾಡ್‌ನಲ್ಲಿರುವ ಪ್ರವರ್ತಕ **ಕೃಷಿ-ಜೈವಿಕ ತಂತ್ರಜ್ಞಾನ ಕಂಪನಿ** (agri-biotech company) ಆಗಿದ್ದು, **೨೦೨೫** ರಲ್ಲಿ ಸ್ಥಾಪನೆಯಾಗಿದೆ.\n\nನಮ್ಮ ಪ್ರಮುಖ ಧ್ಯೇಯವೆಂದರೆ ಕೃಷಿಯಲ್ಲಿ **ಬೆಳವಣಿಗೆಯ ಪೋಷಣೆ** (Nurturing Growth):\n- ಮಣ್ಣಿನ ಫಲವತ್ತತೆ ಹೆಚ್ಚಿಸಲು **ಉತ್ತಮ ದಕ್ಷತೆಯ ಜೈವಿಕ ಗೊಬ್ಬರಗಳು**\n- ಸಾವಯವ ಇಂಗಾಲವನ್ನು ಹೆಚ್ಚಿಸಲು **OMRI-ಪ್ರಮಾಣೀಕೃತ ಸಾವಯವ ಗೊಬ್ಬರಗಳು**\n- ರಾಸಾಯನಿಕ ಮುಕ್ತ ನಿಯಂತ್ರಣಕ್ಕಾಗಿ **ಪರಿಸರ ಸ್ನೇಹಿ ಜೈವಿಕ ಕೀಟನಾಶಕಗಳು**"
      },
      {
        question: "ನೀವು ಯಾವ ಉತ್ಪನ್ನಗಳನ್ನು ನೀಡುತ್ತೀರಿ?",
        answer: "### ನಮ್ಮ ಉತ್ಪನ್ನಗಳ ಪಟ್ಟಿ\nನಾವು ೫ ಪ್ರಮುಖ ವರ್ಗಗಳಲ್ಲಿ **೬೦+ ಪ್ರೀಮಿಯಂ ಕೃಷಿ ಪರಿಹಾರಗಳನ್ನು** ತಯಾರಿಸುತ್ತೇವೆ:\n- **ಜೈವಿಕ ಗೊಬ್ಬರಗಳು:** NB, PB, KB, ZB ಮತ್ತು ಮೈಕೋರೂಟ್ (VAM)\n- **ಬಯೋಸ್ಟಿಮ್ಯುಲಂಟ್ಸ್:** ಬೇರುಗಳ ವಲಯದ ವರ್ಧಕಗಳು (Dhara Maxx, Floral)\n- **ಸಾವಯವ ಪೋಷಕಾಂಶಗಳು:** OMRI-ಪ್ರಮಾಣೀಕೃತ ಭೂಮಿರಿಚ್ ಮತ್ತು ಕ್ರಾಪ್‌ಚಾರ್ಜ್ ಗೊಬ್ಬರ\n- **ಜೈವಿಕ ಕೀಟನಾಶಕಗಳು:** ನೈಸರ್ಗಿಕ ಕೀಟ ನಿಯಂತ್ರಣ ಪರಿಹಾರಗಳು (Orgo Meta, Orgo Neem)\n- **ಸೂಕ್ಷ್ಮ ಪೋಷಕಾಂಶಗಳು:** ಅಗತ್ಯ ಸಮತೋಲಿತ ಖನಿಜಾಂಶಗಳು (Microzest)"
      },
      {
        question: "ನಾನು ಹೇಗೆ ಡೀಲರ್ ಅಥವಾ ವಿತರಕನಾಗಬಹುದು?",
        answer: "### ನಮ್ಮ ಪಾಲುದಾರರ ಜಾಲಕ್ಕೆ ಸೇರಿ\nನಾವು ಇಡೀ **ಭಾರತದಾದ್ಯಂತ** ನಮ್ಮ ಕೃಷಿ ಜಾಲವನ್ನು ಸಕ್ರಿಯವಾಗಿ ವಿಸ್ತರಿಸುತ್ತಿದ್ದೇವೆ!\n\n**ಅರ್ಜಿ ಸಲ್ಲಿಸುವುದು ಹೇಗೆ:**\n- **ಹಂತ ೧:** ನಮ್ಮ ಮೆನುವಿನಲ್ಲಿರುವ **'Become a Partner'** (ಪಾಲುದಾರರಾಗಿ) ವಿಭಾಗಕ್ಕೆ ಹೋಗಿ.\n- **ಹಂತ ೨:** ಡೀಲರ್ ಅಥವಾ ವಿತರಕರ ತ್ವರಿತ ಅರ್ಜಿ ನಮೂನೆಯನ್ನು ಭರ್ತಿ ಮಾಡಿ.\n- **ಹಂತ ೩:** ನಮ್ಮ ಮಾರಾಟ ಅಭಿವೃದ್ಧಿ ತಂಡವು **೨೪ ಗಂಟೆಗಳ ಒಳಗೆ** ನಿಮ್ಮನ್ನು ಸಂಪರ್ಕಿಸುತ್ತದೆ!\n\nನೀವು ನೇರವಾಗಿ **sales@jayagritech.com** ಗೆ ಇಮೇಲ್ ಕಳುಹಿಸುವ ಮೂಲಕವೂ ಪ್ರಾರಂಭಿಸಬಹುದು."
      },
      {
        question: "ನೀವು ಖಾಸಗಿ ಲೇಬಲಿಂಗ್ ಅಥವಾ ಗುತ್ತಿಗೆ ಉತ್ಪಾದನೆಯನ್ನು ನೀಡುತ್ತೀರಾ?",
        answer: "### ಕಸ್ಟಮ್ B2B ಪರಿಹಾರಗಳು\nಹೌದು! ನಾವು **ಗುತ್ತಿಗೆ ಉತ್ಪಾದನೆ** (Contract Manufacturing) ಮತ್ತು **OEM ವೈಟ್/ಪ್ರೈವೇಟ್ ಲೇಬಲಿಂಗ್** ಗಾಗಿ ವಿಶ್ವಾಸಾರ್ಹ ಪಾಲುದಾರರಾಗಿದ್ದೇವೆ.\n\n**ನಮ್ಮ B2B ಸಾಮರ್ಥ್ಯಗಳು:**\n- ಅತ್ಯಾಧುನಿಕ ಮೈಕ್ರೋಬಾಯಾಲಜಿ ಮತ್ತು ಫಾರ್ಮುಲೇಶನ್ **R&D ಪ್ರಯೋಗಾಲಯ**\n- ಕಸ್ಟಮ್ ದ್ರವ, ಪುಡಿ ಮತ್ತು ಗ್ರ್ಯಾನ್ಯೂಲ್ ಸಂಯೋಜನೆಗಳು\n- ಸಂಪೂರ್ಣವಾಗಿ ಪ್ರಮಾಣೀಕೃತ **ISO 9001:2015 ಮತ್ತು FCO** ಮಾನದಂಡಗಳ ಅನುಸರಣೆ\n- ವೇಗದ ಮಾರುಕಟ್ಟೆ ವಿಸ್ತರಣೆಗಾಗಿ ವೈಟ್ ಲೇಬಲ್ ಆಯ್ಕೆಗಳು"
      },
      {
        question: "ನಿಮ್ಮ ಕಂಪನಿ ಎಲ್ಲಿದೆ?",
        answer: "### ನಮ್ಮ ಸ್ಥಳ\nನಮ್ಮ ಕಾರ್ಪೊರೇಟ್ ಪ್ರಧಾನ ಕಚೇರಿ ಮತ್ತು ಉತ್ಪಾದನಾ ಘಟಕಗಳು ಭಾರತದ **ಗುಜರಾತ್‌ನ ವಲ್ಸಾಡ್‌ನಲ್ಲಿ** ಇವೆ.\n\n- **ವಲ್ಸಾಡ್** ಅತ್ಯುತ್ತಮ ಸಾರಿಗೆ ಸಂಪರ್ಕವನ್ನು ಹೊಂದಿರುವ ಪಶ್ಚಿಮ ಭಾರತದ ಪ್ರಮುಖ ಕೈಗಾರಿಕಾ ವಲಯವಾಗಿದೆ.\n- ನಮ್ಮ **Contact** (ಸಂಪರ್ಕ) ಪುಟದಲ್ಲಿ ನೀವು ನಮ್ಮ **ನಿಖರವಾದ ಸ್ಥಳ ಮತ್ತು ಮಾರ್ಗ ನಕ್ಷೆಯನ್ನು** ವೀಕ್ಷಿಸಬಹುದು."
      },
      {
        question: "ನಿಮ್ಮ ಉತ್ಪನ್ನಗಳು ಯಾವ ಪ್ರಮಾಣೀಕರಣಗಳನ್ನು ಹೊಂದಿವೆ?",
        answer: "### ಪ್ರಮಾಣೀಕೃತ ಸಾವಯವ ಮತ್ತು ಗುಣಮಟ್ಟ ಪರೀಕ್ಷಿತ\nನಮ್ಮ ಉತ್ಪನ್ನಗಳನ್ನು ಕಟ್ಟುನಿಟ್ಟಾದ ಗುಣಮಟ್ಟದ ನಿಯಂತ್ರಣದಲ್ಲಿ ತಯಾರಿಸಲಾಗುತ್ತದೆ ಮತ್ತು ಹಲವಾರು ರಾಷ್ಟ್ರೀಯ ಹಾಗೂ ಅಂತರರಾಷ್ಟ್ರೀಯ ಪ್ರಮಾಣೀಕರಣಗಳನ್ನು ಹೊಂದಿವೆ:\n- ಪ್ರಮಾಣೀಕೃತ ಸಾವಯವ ಕೃಷಿಯಲ್ಲಿ ಬಳಕೆಗಾಗಿ **OMRI ಪಟ್ಟಿ ಮಾಡಲ್ಪಟ್ಟಿದೆ**.\n- **ISO 9001:2015** ಪ್ರಮಾಣೀಕೃತ ಉತ್ಪಾದನಾ ಮತ್ತು R&D ಸೌಲಭ್ಯಗಳು.\n- **FCO (ಗೊಬ್ಬರ ನಿಯಂತ್ರಣ ಕಾಯ್ದೆ)** ಅನುಸರಣೆಯ ಫಾರ್ಮುಲೇಶನ್‌ಗಳು.\n- **NPOP (ಸಾವಯವ ಉತ್ಪಾದನೆಗಾಗಿ ರಾಷ್ಟ್ರೀಯ ಕಾರ್ಯಕ್ರಮ)** ಪ್ರಮಾಣೀಕೃತ ಸಾವಯವ ಗೊಬ್ಬರಗಳು."
      },
      {
        question: "ಜೈವಿಕ ಗೊಬ್ಬರಗಳು ಮಣ್ಣಿನ ಜೀವಶಾಸ್ತ್ರವನ್ನು ಹೇಗೆ ಸುಧಾರಿಸುತ್ತವೆ?",
        answer: "### ಮಣ್ಣಿನ ಜೀವಶಾಸ್ತ್ರದ ಮರುಸ್ಥಾಪನೆ\nಜೈವಿಕ ಗೊಬ್ಬರಗಳು ಜೀವಂತ ಸೂಕ್ಷ್ಮಜೀವಿಗಳನ್ನು ಹೊಂದಿದ್ದು ಮಣ್ಣಿನ ಆರೋಗ್ಯವನ್ನು ನೈಸರ್ಗಿಕವಾಗಿ ಸುಧಾರಿಸುತ್ತವೆ:\n- **ಸಾರಜನಕ ಸ್ಥಿರೀಕರಣ:** ವಾತಾವರಣದ ಸಾರಜನಕವನ್ನು ಗ್ರಹಿಸಿ ಸಸ್ಯಗಳಿಗೆ ಲಭ್ಯವಾಗುವಂತೆ ಮಾಡುತ್ತದೆ.\n- **ಪೋಷಕಾಂಶಗಳ ಕರಗಿಸುವಿಕೆ:** ಮಣ್ಣಿನಲ್ಲಿ ಕರಗದ ರಂಜಕ, ಪೊಟ್ಯಾಶ್ ಮತ್ತು ಸತುವನ್ನು ಸಸ್ಯಗಳು ಹೀರಿಕೊಳ್ಳುವ ರೂಪಕ್ಕೆ ಪರಿವರ್ತಿಸುತ್ತದೆ.\n- **ಸೂಕ್ಷ್ಮಜೀವಿಗಳ ಸಂವರ್ಧನೆ:** ಮಣ್ಣಿನ ಸಾವಯವ ಇಂಗಾಲದ ಮಟ್ಟ ಮತ್ತು ಉಪಯುಕ್ತ ಸೂಕ್ಷ್ಮಜೀವಿಗಳ ಚಟುವಟಿಕೆಯನ್ನು ಹೆಚ್ಚಿಸುತ್ತದೆ."
      },
      {
        question: "ನಾವು ಪ್ರಯೋಗಗಳಿಗಾಗಿ ಉತ್ಪನ್ನದ ಮಾದರಿಗಳನ್ನು ವಿನಂತಿಸಬಹುದೇ?",
        answer: "### ಉತ್ಪನ್ನದ ಮಾದರಿಗಳಿಗಾಗಿ ವಿನಂತಿ\nಹೌದು! ನಾವು ಕ್ಷೇತ್ರ ಪ್ರಯೋಗಗಳು ಮತ್ತು ವಾಣಿಜ್ಯ ಪರೀಕ್ಷೆಗಳಿಗೆ ಬಲವಾದ ಬೆಂಬಲ ನೀಡುತ್ತೇವೆ:\n- **ಯಾರು ಅರ್ಜಿ ಸಲ್ಲಿಸಬಹುದು:** ನೋಂದಾಯಿತ ವಿತರಕರು, ವಾಣಿಜ್ಯ ರೈತರು ಮತ್ತು ಸಾಂಸ್ಥಿಕ ಖರೀದಿದಾರರು.\n- **ಪ್ರಯೋಗದ ಬೆಂಬಲ:** ನಮ್ಮ ಕೃಷಿ ತಜ್ಞರ ತಂಡವು ಡೋಸೇಜ್‌ಗಳು ಮತ್ತು ಬಳಕೆಯ ವಿಧಾನಗಳ ಬಗ್ಗೆ ನಿಮಗೆ ಮಾರ್ಗದರ್ಶನ ನೀಡುತ್ತದೆ.\n- **ವಿನಂತಿಸುವುದು ಹೇಗೆ:** ನಿಮ್ಮ ಸ್ಥಳೀಯ ಮಾರಾಟ ವ್ಯವಸ್ಥಾಪಕರನ್ನು ಸಂಪರ್ಕಿಸಿ ಅಥವಾ ನಮ್ಮ **Contact Us** ಫಾರ್ಮ್ ಮೂಲಕ ವಿನಂತಿಯನ್ನು ಕಳುಹಿಸಿ."
      }
    ],
    zh: [
      {
  ...
  const greetings = {
    ...
    kn: "ನಮಸ್ಕಾರ! 👋 ಜಯ್ ಅಗ್ರಿಟೆಕ್‌ಗೆ ಸುಸ್ವಾಗತ. ಹೆಚ್ಚಿನ ವಿವರಗಳಿಗಾಗಿ ಕೆಳಗಿನ ಯಾವುದೇ ಪ್ರಶ್ನೆಗಳನ್ನು ಕ್ಲಿಕ್ ಮಾಡಿ, ಅಥವಾ ನಮ್ಮ ಪುಟಗಳಲ್ಲಿನ ಫಾರ್ಮ್‌ಗಳನ್ನು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಭರ್ತಿ ಮಾಡಲು **Agent Co-Pilot** ಅನ್ನು ಪ್ರಾರಂಭಿಸಿ!",
  ...
  const popupAlternatives = {
    ...
    mr: [
      ...
      "आमचे Co-Pilot आत्ताच वापरून पहा — फॉर्म स्वयंचलितपणे भरा आणि quotation मिळवा!"
    ],
    kn: [
      "ನಮಸ್ಕಾರ! ಇಂದು ನಾನು ನಿಮಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಬಹುದು? 👋",
      "ನಮ್ಮ Co‑Pilot ಅನ್ನು ಈಗಲೇ ಪ್ರಯತ್ನಿಸಿ — ಫಾರ್ಮ್‌ಗಳನ್ನು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಭರ್ತಿ ಮಾಡಿ ಮತ್ತು ಉಲ್ಲೇಖಗಳನ್ನು ಪಡೆಯಿರಿ!"
    ],
    zh: [
      "您好！今天我能为您做些什么？ 👋",
            ...
            {!agentMode && (
              <div className="chatbot-quick-questions">
                ...
                <span className="cqq-title">
                  {activeLang === 'zh' ? '💡 推荐问题：' : activeLang === 'hi' ? '💡 सुझाये गए प्रश्न:' : activeLang === 'gu' ? '💡 સૂચવેલા પ્રશ્નો:' : activeLang === 'mr' ? '💡 सुचवलेले प्रश्न:' : activeLang === 'kn' ? '💡 ಸೂಚಿಸಲಾದ ಪ್ರಶ್ನೆಗಳು:' : '💡 Suggested Questions:'}
                </span>
                <div className="cqq-list">
